                ...
                <div class="tables">
                    <div class="firstTable">
                        <table class="table table-bordered table-sm">
                            ...
                            <tr><th>Affected Users Count</th><td class="badge bg-danger p-1 m-2" id="modal-affected-users"></td></tr>
                        </table>
                    </div>
                    ...
                    <div class="thirdTable" id="modal-third-table">
                        <table class="table table-bordered">
                            <tr><th>Status</th><td id="modal-status"></td></tr>
                            <tr><th>Priority</th><td id="modal-priority"></td></tr>
                            <tr><th>Issue Due Date</th><td id="modal-due-date"></td></tr>
                            <tr><th>Assigned Tech</th><td id="modal-assigned-tech"></td></tr>
                            <tr><th>Issue Resolved At</th><td id="modal-resolved-at"></td></tr>
                            <tr><th>Remark</th><td id="modal-remark"></td></tr>
                        </table>
                    </div>
                </div>
            </div>
